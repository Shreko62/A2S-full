 ...
 */
final class Version20190923152220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_404021BFA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__formation AS SELECT id, titre, message FROM formation');
        $this->addSql('DROP TABLE formation');
        $this->addSql('CREATE TABLE formation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY, message CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO formation (id, titre, message) SELECT id, titre, message FROM __temp__formation');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__formation AS SELECT id, titre, message FROM formation');
        $this->addSql('DROP TABLE formation');
        $this->addSql('CREATE TABLE formation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, message CLOB DEFAULT NULL, user_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO formation (id, titre, message) SELECT id, titre, message FROM __temp__formation');
        $this->addSql('DROP TABLE __temp__formation');
